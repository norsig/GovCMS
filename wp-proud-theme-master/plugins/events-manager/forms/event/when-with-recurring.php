...
<div id="em-form-with-recurrence" class="event-form-with-recurrence event-form-when">
	...
	<div class="em-date-range form-group form-inline">
		<div class="em-recurring-text"><?php _e ( 'Recurrences span ', 'events-manager'); ?></div>
		<div class="form-group">
			<span class="em-event-text"><?php _e ( 'From ', 'events-manager'); ?></span>				
			<input class="form-control em-date-start em-date-input-loc" type="text" />
		...
		<div class="form-group">
			...
			<input class="form-control em-date-end em-date-input-loc" type="text" />
	...
	<div class="form-group form-inline">
		<div class="form-group">
			...
			<input id="start-time" class="form-control em-time-input em-time-start" type="text" size="8" maxlength="8" name="event_start_time" value="<?php echo date( $hours_format, $EM_Event->start ); ?>" />
		</div>
		<div class="form-group">
			<?php _e('to','events-manager'); ?>
			<input id="end-time" class="form-control em-time-input em-time-end" type="text" size="8" maxlength="8" name="event_end_time" value="<?php echo date( $hours_format, $EM_Event->end ); ?>" />
	...
	<div class="em-recurring-text form-group form-inline">
		<p>
			<?php _e ( 'This event repeats', 'events-manager'); ?> 
			<select id="recurrence-frequency" name="recurrence_freq" class="form-control">
				<?php
		...
		<p class="alternate-selector" id="monthly-selector" style="display:inline-block;">
