	...
	<div class="form-inline">
		...
		<span class="em-booking-date-normal">
			<span class="em-date-single">
				<input id="em-bookings-date-loc" class="form-control em-date-input-loc" type="text" />
		...
		<span class="em-booking-date-recurring">
			<input class="form-control" type="text" name="recurrence_rsvp_days" size="3" value="<?php echo absint($EM_Event->recurrence_rsvp_days); ?>" />
			<?php _e('day(s)','events-manager'); ?>
			<select class="form-control" name="recurrence_rsvp_days_when">
		...
		<input class="form-control" type="text" name="event_rsvp_time" class="em-time-input" maxlength="8" size="8" value="<?php echo date( em_get_hour_format(), $EM_Event->rsvp_end ); ?>" />
		<br />
