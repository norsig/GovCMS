...
class search_FAQ_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      'faq_search', // Base ID
      __( 'FAQ Widget - Search', 'faq-widgets' ), // Name
      array( 'description' => __( 'Puts a search box for just FAQs', 'faq-widgets' ), ) // Args
    );
  }
...
class random_FAQ_Widget extends WP_Widget {
  function __construct() {
    parent::__construct(
      'faq_random', // Base ID
      __( 'FAQ Widget - Random', 'faq-widgets' ), // Name
      array( 'description' => __( 'Lists a single random FAQ on the sidebar', 'faq-widgets' ), ) // Args
    );
  }
...
class recent_FAQ_Widget extends WP_Widget {
  function __construct() {
    parent::__construct(
      'recent_questions', // Base ID
      __( 'FAQ Widget - Recent', 'faq-widgets' ), // Name
      array( 'description' => __( 'List recent questions', 'faq-widgets' ), ) // Args
    );
  }
...
class topics_FAQ_Widget extends WP_Widget {
  function __construct() {
    parent::__construct(
      'recent_faqtax', // Base ID
      __( 'FAQ Widget - Taxonomies', 'faq-widgets' ), // Name
      array( 'description' => __( 'List FAQ topics or tags', 'faq-widgets' ), ) // Args
    );
  }
...
class cloud_FAQ_Widget extends WP_Widget {
  function __construct() {
    parent::__construct(
      'faq_cloud', // Base ID
      __( 'FAQ Widget - Cloud', 'faq-widgets' ), // Name
      array( 'description' => __( 'A tag cloud of FAQ topics and tags', 'faq-widgets' ), ) // Args
    );
  }
