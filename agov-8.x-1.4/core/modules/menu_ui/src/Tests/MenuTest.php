...
class MenuTest extends MenuWebTestBase {
  ...
  public function testExpandAllItems() {
    ...
    $item1 = $this->addMenuLink('', '/node/' . $node->id(), $menu->id(), FALSE);
    $item2 = $this->addMenuLink($item1->getPluginId(), '/node/' . $node->id(), $menu->id(), FALSE);
    $item3 = $this->addMenuLink($item1->getPluginId(), '/node/' . $node->id(), $menu->id());
    ...
    $this->verifyMenuLink($item1, $node);
    $this->verifyMenuLink($item2, $node);
    $this->verifyMenuLink($item3, $node);
  }
